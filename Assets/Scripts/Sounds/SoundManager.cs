...
public class SoundManager : MonoBehaviour
{
    ...
    public int PlayAtLocation(SoundVariationizer variationizer, Vector3 location, SoundSetting soundSettingOverwrite = null)
    {
        if (soundSettingOverwrite != null)
        {
            soundSettingOverwrite.Pitch = variationizer.Pitch;
        ...
        return PlayAtLocation(variationizer.SoundName, location, soundSettingOverwrite);
    }
